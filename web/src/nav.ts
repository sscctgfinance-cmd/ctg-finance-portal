...
export const FINANCE_NAV: NavEntry[] = [
  ...
  { app: 'finance', id: 'approvals', label: '✅ Approvals', group: 'operations', migrated: false },
  { app: 'finance', id: 'collections', label: '📨 Collections', group: 'operations', migrated: false },
  ...
  { app: 'finance', id: 'recon', label: '🏦 Bank Rec', group: 'operations', migrated: false },
  { app: 'finance', id: 'gateway', label: '🔁 Gateway → Xero', group: 'operations', migrated: false },
  { app: 'finance', id: 'bankfeed', label: '🔗 Bank Feed', group: 'operations', migrated: false },
  { app: 'finance', id: 'salesrecon', label: '📊 Sales Reconciliation', group: 'operations', migrated: false },
  { app: 'finance', id: 'close', label: '📋 Close', group: 'operations', migrated: false },
  { app: 'finance', id: 'calendar', label: '📅 Calendar', group: 'operations', migrated: false },
  ...
  { app: 'finance', id: 'pharm', label: '🏪 Pharmacies', group: 'data', migrated: false },
