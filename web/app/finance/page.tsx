...
// above is the nav — one migrated tab renders here, the other 21 open in app.html at their `#tab=`.
  ...
  return (
    <div className="panel">
      ...
      <div className="muted" style={{ fontSize: '12.5px', lineHeight: 1.6 }}>
        Pick a tab above. The migrated ones render here from the same session and the same backend; the
        rest open <a href={`${BASE_PATH}/app.html`}>app.html</a> at that tab, unchanged and still the app
        staff use. What is listed is what your permissions allow — the server gates every one of them
        again regardless.
      </div>
    </div>
  );
